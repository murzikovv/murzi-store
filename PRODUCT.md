...
One-page storefront selling premium single-file HTML website templates and business documents (pitch deck, budget tracker, resumes). Checkout happens in a Telegram bot (@murzistudio_bot) paid with Telegram Stars; every "Buy" button deep-links `t.me/murzistudio_bot?start=buy_<slug>`.

- register: brand (the storefront IS the portfolio piece; it must out-design the templates it sells)
