...
PINS = [
    ...
    ("salon", "salon.png", "Beauty salon",
     "A salon site that<br><em>fills the book</em>",
     "Full price menu, gallery, stylist team and online booking. Warm & boutique.", "★ 690"),
    ("wedding", "wedding.png", "Wedding",
     "A wedding site<br>guests <em>actually use</em>",
     "Live countdown, story, schedule, venue, gallery, registry and RSVP form.", "★ 690"),
    ("cafe", "cafe.png", "Café · coffee",
     "A café site that<br><em>smells like coffee</em>",
     "Split hero, a full menu, roastery story, hours and order-ahead. Cosy & warm.", "★ 690"),
